...
Authentic Boot Simulator: A high-fidelity simulator that recreates the "mechanical" feeling of a system startup. Sequences feature period-accurate typography, instant character output, and authentic system diagnostic diagnostics.

Era-Specific Aesthetics: Each entry utilizes distinct Google Font stacks (VT323, Orbitron, JetBrains Mono) and color palettes to recreate the physical limitations and artistic styles of specific computing decades.
...
Architecture: Single-file architecture with a centralized event-delegated router for smooth state transitions.

Typography: A curated selection of web fonts (Inter, JetBrains Mono, VT323, Orbitron) mapped to specific computing eras.
